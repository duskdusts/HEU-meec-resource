...
TXT_EXTS = ['md', 'txt']
TXT_URL_PREFIX = 'https://proxy.223886.xyz/github.com/duskdusts/HEU-meec-resource/blob/main/'
BIN_URL_PREFIX = 'https://proxy.223886.xyz/github.com/duskdusts/HEU-meec-resource/raw/main/'
